 ...
 * @author bruno
 */
public class FormsEquipamento extends javax.swing.JFrame {

    /**
     * Creates new form FormsEquipamento
     */
    public FormsEquipamento() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormsEquipamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormsEquipamento().setVisible(true);
            }
        });
    }
