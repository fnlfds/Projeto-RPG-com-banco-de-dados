 ...
 * @author bruno
 */
public class FormsHabilidade extends javax.swing.JFrame {

    /**
     * Creates new form FormsHabilidade
     */
    public FormsHabilidade() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormsHabilidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormsHabilidade().setVisible(true);
            }
        });
    }
